...
scp -i c:\dev\elastic-mapreduce-ruby\ch4mp_aws_key.pem .\lab5-avro-complete\target\lab5-1.0.0-SNAPSHOT.jar hadoop@ec2-54-229-69-74.eu-west-1.compute.amazonaws.com:/home/hadoop/job/lab5-1.0.0-SNAPSHOT.jar
ssh -i c:\dev\elastic-mapreduce-ruby\ch4mp_aws_key.pem hadoop@ec2-54-229-69-74.eu-west-1.compute.amazonaws.com
java -cp "/home/hadoop/*:/home/hadoop/lib/*:/home/hadoop/job/lab5-1.0.0-SNAPSHOT.jar" com.c4soft.hadoop.Main
