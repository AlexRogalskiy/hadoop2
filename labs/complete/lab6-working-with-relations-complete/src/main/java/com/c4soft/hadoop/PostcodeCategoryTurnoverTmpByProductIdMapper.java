...
public class PostcodeCategoryTurnoverTmpByProductIdMapper extends
    ...
    protected void map(AvroKey<PostcodeCategoryTurnoverTmp> key, NullWritable value, Context context) throws IOException, InterruptedException {
        ...
        context.write(new LongWritable(tmp.getProductId()), new AvroValue<PostcodeCategoryTurnoverTmp>(tmp));
    }
