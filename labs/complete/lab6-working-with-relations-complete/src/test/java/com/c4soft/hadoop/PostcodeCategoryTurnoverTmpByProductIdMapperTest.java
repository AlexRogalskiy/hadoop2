...
import com.c4soft.hadoop.PostcodeCategoryTurnoverTmpByProductIdMapper;
import com.c4soft.hadoop.avro.PostcodeCategoryTurnoverTmp;

public class PostcodeCategoryTurnoverTmpByProductIdMapperTest {
    ...
    public void test() throws IOException {
        ...
        mapDriver.addOutput(new LongWritable(2L), new AvroValue<PostcodeCategoryTurnoverTmp>(tmp));
